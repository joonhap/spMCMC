...
## Note that the code below is the same as one in the directory spMCMC/experiments (the parent folder to the location of this file), except that the directions of openings of C's and the radius of the C's have been changed.

sidelen <- 4 # the length of a side of the square-shaped space
radius <- .7 # the radius of a "C"
...
slitangle <- c(.22*pi, .78*pi, 1.22*pi, -.22*pi) # the angle of openings
