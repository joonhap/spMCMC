...
save(eps, algo, repNo, runtime, moveprob, nfail, log2len, sym, eps.trace, accep.prob.trace, ESS.coda, minESS.coda, minESS.coda.perSec, avgESS.coda, avgESS.coda.perSec, file=paste('data/mvnorm_',algo,'_eps_',signif(eps,digits=2),ifelse(adaptive.massInv,"","_fixedmass"),'_N_',N,'_astar_',astar,'_repNo_',repNo,'.RData',sep=''))
